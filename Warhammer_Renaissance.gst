...
<gameSystem id="1216-28de-7047-6b53" name="Warhammer Renaissance" revision="8" battleScribeVersion="2.03" authorName="M. Strårup" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <sharedSelectionEntries>
    ...
    <selectionEntry id="2fd4-7250-7c22-c082" name="Bow" publicationId="78e3-1ead-0759-9022" hidden="false" collective="false" import="true" type="upgrade">
      <modifiers>
        <modifier type="increment" field="fcac-3c52-8cf7-add0" value="2.0">
          <repeats>
            <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="model" repeats="1" roundUp="false"/>
      ...
      <constraints>
        <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="1ab0-4b10-6bf7-1b60" type="max"/>
      </constraints>
      <infoLinks>
        <infoLink id="05ff-9794-56d6-96a0" name="Bow" publicationId="78e3-1ead-0759-9022" hidden="false" targetId="b438-5e24-529c-3a0c" type="profile"/>
      </infoLinks>
      <costs>
        <cost name="pts" typeId="fcac-3c52-8cf7-add0" value="0.0"/>
      </costs>
    </selectionEntry>
    <selectionEntry id="8eac-d7e3-f6c4-36d2" name="Short Bow" publicationId="78e3-1ead-0759-9022" hidden="false" collective="false" import="true" type="upgrade">
      <modifiers>
        <modifier type="increment" field="fcac-3c52-8cf7-add0" value="1.0">
          <repeats>
            <repeat field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="model" repeats="1" roundUp="false"/>
      ...
      <constraints>
        <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="3240-e3ee-b4e9-797e" type="max"/>
      </constraints>
      <infoLinks>
        <infoLink id="a8df-986d-81ea-f4f5" name="Short Bow" publicationId="78e3-1ead-0759-9022" hidden="false" targetId="ecb6-3d3b-03e4-dade" type="profile"/>
      </infoLinks>
      <costs>
        <cost name="pts" typeId="fcac-3c52-8cf7-add0" value="0.0"/>
      </costs>
